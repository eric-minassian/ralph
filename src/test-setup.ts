...
import importJson from './locales/en/import.json'

// Initialize i18n for tests with real translation files
void i18n.use(initReactI18next).init({
  lng: 'en',
  fallbackLng: 'en',
  ns: ['common', 'navigation', 'errors', 'userPools', 'users', 'validation', 'devices', 'webauthn', 'groups', 'appClients', 'identityProviders', 'domains', 'resourceServers', 'import'],
  defaultNS: 'common',
  resources: {
    en: {
      common,
